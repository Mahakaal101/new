...
BOT_TOKEN = environ.get('BOT_TOKEN', "5931548571:AAE6-oizPAQT2FKFQXcxttuYkRV--0qvDl0")
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -100152957746))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -100152957746))
